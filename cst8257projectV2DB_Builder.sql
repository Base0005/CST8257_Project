CREATE DATABASE IF NOT EXISTS `cst8257project`
...
VALUES ('private', 'Accessible only by the owner '),
...
VALUES (
    'accepted',
    'The request to become a friend has been accepted'
  ),
  (
    'request',
    'A request has been sent to become a friend'
  );
...
;
INSERT INTO user (UserId, Name, Phone, Password)
VALUES ('user1', 'John Smith', '613-555-1234', 'pass123'),
  ('user2', 'Jane Doe', '613-555-5678', 'pass456'),
  ('user3', 'Bob Wilson', '613-555-9012', 'pass789'),
  (
    'kikedamo',
